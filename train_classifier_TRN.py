...
def main():
    ...
    for m in modalities:
        ...
        models[m] = getattr(model_list, args.models[m].model)(args.models[m].num_input, args.models[m].num_classes, args.train.num_clips)
...
def train(action_classifier, train_loader, val_loader, device, num_classes):
    ...
    for i in range(iteration, training_iterations):
        ...
        for m in modalities:
            ...
            #data[m] = data[m] = torch.reshape(data[m], (args.models[m].num_clips, 32, 1024)) #this has to be changed according to late fusion or not 
